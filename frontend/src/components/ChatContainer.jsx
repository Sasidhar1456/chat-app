  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
        ...
        <img className='md:hidden max-w-7 ' onClick={() => setSelectedUser()}
          ...
          messages.map((msg, index) => (
            <div key={index} className={`flex items-end gap-2 justify-end 
              ...
              <div className="text-center text-xs">
                <img src={msg.senderId === authUser._id ? authUser?.profilePic || assets.avatar_icon : selectedUser?.profilePic || assets.avatar_icon} alt="" className='w-7
                  rounded-full' />
      ...
      <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
          <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
            ...
            onKeyDown={(e) => e.key === "Enter" ? handleSendMessage(e) : ""} type="text" placeholder='send a message' 
    ...
    bg-white/10 max-md:hidden'>
      ...
      <p className='text-lg font-medium text-white'>Chat anytime, anytime</p>
    </div>
  )
}
